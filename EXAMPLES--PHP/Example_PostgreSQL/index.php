...
if(isset($_POST['input']))
 {
    ...
    // Заносим человека
    mysqli_query($db,"CALL insert_emp('$surname', '$name', '$kraina', '$posada')");

     // Присваиваем человеку ID код
    $query = mysqli_query($db,"SELECT id FROM employees WHERE surname = '$surname'");
    $data = mysqli_fetch_array($query);
    $id = $data['id'];
    mysqli_query($db,"INSERT INTO kod(id,kod) VALUES($id,'$id_kod')");
 }
 ...
 if(isset($_POST['del_emp']))
  {
    ...
    mysqli_query($db,"CALL del_emp($id_emp)");
}
?>
              ...
              <div class="col-sm-11 well" >
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $query1 =  mysqli_query($db,"SELECT * FROM emp_kr_pos");
              ...
              <div class="col-sm-11 well" >
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $query1 =  mysqli_query($db,"SELECT * FROM emp_kod");
                    while($data1 = mysqli_fetch_array($query1))
                     {  ?>
                          <tr>
                            <td><?php echo $data1['name']; ?></td>
...
<div class="col-sm-11 well" >
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  $query1 =  mysqli_query($db,"SELECT * FROM log");
                  while($data1 = mysqli_fetch_array($query1))
                   {  ?>
                        <tr>
